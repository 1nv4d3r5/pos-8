            ...
            do
            {
                ...
                if (buffer.Length > 5)
                {
                    ...
                    if (buffer[5] == MAVLINK_MSG_ID_PARAM_VALUE)
                    {
                        ...
                        {
                            log.Info("Sudah terdapat " + (par.param_index) + " '" + paramID + "'");
                            this.frmProgressReporter.UpdateProgressAndStatus((indexsreceived.Count * 100) / param_total, "Sudah terdapat " + paramID);
                            continue;
                        }
                        ...
                        if (!MainV2.MONO)
                            log.Info(DateTime.Now.Millisecond + " ambil parameter " + (par.param_index) + " pada " + (par.param_count) + " nama: " + paramID);
                        ...
                        this.frmProgressReporter.UpdateProgressAndStatus((indexsreceived.Count * 100) / param_total, "Ambil parameter " + paramID);
